...
@Service
@Slf4j
public class DietaryGuidelinesTokenTextSplitter extends TextSplitter {
    ...
    public DietaryGuidelinesTokenTextSplitter() {
        this(DEFAULT_CHUNK_SIZE, MIN_CHUNK_SIZE_CHARS, MIN_CHUNK_LENGTH_TO_EMBED, MAX_NUM_CHUNKS, KEEP_SEPARATOR);
    }

    public DietaryGuidelinesTokenTextSplitter(boolean keepSeparator) {
        this(DEFAULT_CHUNK_SIZE, MIN_CHUNK_SIZE_CHARS, MIN_CHUNK_LENGTH_TO_EMBED, MAX_NUM_CHUNKS, keepSeparator);
    }

    public DietaryGuidelinesTokenTextSplitter(int chunkSize, int minChunkSizeChars, int minChunkLengthToEmbed, int maxNumChunks,
...
//                    )
    ...
    public static final class Builder {
        ...
        public DietaryGuidelinesTokenTextSplitter build() {
            return new DietaryGuidelinesTokenTextSplitter(this.chunkSize, this.minChunkSizeChars, this.minChunkLengthToEmbed,
